...
class Subject(models.Model):
    ...
    subjectname = models.CharField('Subject Name', db_column='subjectName', unique=True, max_length=30,)  # Field name made lowercase.
...
class Topic(models.Model):
    ...
    topicname = models.CharField('Topic Name', db_column='topicName', unique=True, max_length=50)  # Field name made lowercase.
